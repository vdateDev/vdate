...
class Controller_Agency_Sprav extends Controller_Agency {
    
    public function action_index() {
  
        $category=$this->request->param('category');
        $data =Model_Sprav::get_sprav_backend($category);
        $this->template->content = View::factory('agency/sprav/'.$category.'/index')
                                        ->set('data', $data)
    ...
    public function action_add() {
        ...
        $this->template->content = View::factory('agency/sprav/'.$category.'/add')
                                    ->bind('data', $post)
    ...
    public function action_edit() {
        ...
        if (!$sprav->loaded()) {
            ...
            $this->redirect(strtolower(Route::url('agency', array('controller' => 'sprav','category'=>$category, 'action'=>'index'))));
        ...
        $this->template->content = View::factory('agency/sprav/'.$category.'/edit')
                                    ->bind('data', $data)
                                    ->bind('languages', $languages);
    }
    ...
    public function action_delete() {
        ...
        $this->redirect(strtolower(Route::url('agency_sprav', array('controller' => 'Sprav','category'=>$this->request->param('category'), 'action'=>'index'))));
    }
