...
class Controller_Agency_Gifts extends Controller_Agency {
    ...
    public function action_index() {
        ...
        $categories=Model_GiftGroups::get_tree_backend(0,'agency/gifts/select',$group_id);
        $gifts = Model_Gifts::get_gifts_backend($group_id,$status,$created_at_start, $created_at_end, $sort, $limit, $pagination->offset);
        $this->template->content = View::factory('agency/gifts/index')
    ...
    public function action_add() {
        ...
        $categories=Model_GiftGroups::get_tree_backend(0,'agency/gifts/select',$cur_parent);
        $this->template->content = View::factory('agency/gifts/add')
                                    ->bind('data', $post)
    ...
    public function action_edit() {
        ...
        if (!$gifts->loaded()) {
            ...
            $this->redirect(strtolower(Route::url('agency', array('controller' => 'gifts'))));
        ...
        $categories=Model_GiftGroups::get_tree_backend(0,'agency/gifts/select',$data['group_id']);
        
        $this->template->content = View::factory('agency/gifts/edit')
                                    ->bind('data', $data)
                                    ->bind('languages', $languages)
                                    ->bind('categories',$categories);
    }
