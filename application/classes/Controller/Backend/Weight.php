...
class Controller_Backend_Weight extends Controller_Backend {
    
    public function action_index() {
        
        $weight = Model_Weight::get_weight();
        
        $this->template->content = View::factory('backend/weight/index')
                                    ->set('weight', $weight);
    ...
    public function action_edit() {
        ...
        if (!$weight->loaded()) {
            ...
            $this->redirect(Route::url('backend', array('controller' => 'weight')));
        ...
        $this->template->content = View::factory('backend/weight/edit')
                                    ->set('data', $data);
    }
    ...
    public function action_add() {
        ...
        $this->template->content = View::factory('backend/weight/add')
                                    ->bind('data', $post);
    ...
    public function action_delete() {
        ...
        $this->redirect(strtolower(Route::url('backend', array('controller' => 'weight'))));
    }
}