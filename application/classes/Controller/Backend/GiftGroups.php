...
class Controller_Backend_GiftGroups extends Controller_Backend {
    
    public function action_index() {
  
        $groups =Model_GiftGroups::get_tree_backend(0,'backend/giftGroups/tree');
        $this->template->content = View::factory('backend/giftGroups/index')
                                        ->set('groups', $groups);
    ...
    public function action_add() {
        ...
        $this->template->content = View::factory('backend/giftGroups/add')
                                    ->bind('data', $post)
    ...
    public function action_edit() {
        ...
        if (!$groups->loaded()) {
            ...
            $this->redirect(strtolower(Route::url('backend', array('controller' => 'giftGroups'))));
        ...
        $this->template->content = View::factory('backend/giftGroups/edit')
                                    ->bind('data', $data)
