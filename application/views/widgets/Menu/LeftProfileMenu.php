        ...
        <div class="leftSIDE_content">
                ...
                <ul class="accountList">
                    <?php if ($role->name=='girls'): ?>
                        ...
                        <li><a href="#" class="acc_myfavorites"><?php echo __('my_favorites'); ?></a></li>
                        ...
                        <li><a href="#" class="acc_information"><?php echo __('information'); ?></a></li>
                        <li><a href="#" class="acc_howusechat"><?php echo __('how_to_use_a_chat'); ?></a></li>
