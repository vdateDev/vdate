...
<body>
	<section class="isSection indexPage">
		...
		<div id="conteiner">
			<div class="site_size clearFix">
				<div class="rightSIDE">
                                    <?php if (isset($widgets['Slider']))  echo $widgets['Slider']; ?>
					<div class="indexModuleWrapp">
                                            <?php if (isset($widgets['OnlineInMainPage'])) echo $widgets['OnlineInMainPage']; ?>      
						<div class="indexMod02">
                                                        <?php if (isset($widgets['JoinForFreeMainPage'])) echo $widgets['JoinForFreeMainPage']; ?>
                                                        <?php if (isset($widgets['FreeVideoChat'])) echo $widgets['FreeVideoChat'];?>
						</div>
                                            <?php if (isset($widgets['NewGirlsOnMainPage'])) echo $widgets['NewGirlsOnMainPage']; ?>
					</div>
				</div><!-- .rightSIDE -->
			</div><!-- .site_size -->
		</div><!-- .indexConteiner -->
