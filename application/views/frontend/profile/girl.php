<div class="leftSIDE">
        ...
        <div class="leftSIDE_content">
                <div class="ladiesPhoto">
                        ...
                        <a href="#" class="ladiesReit add_to_fav" data-id="<?php echo $girl->user_id; ?>"></a>
                </div><!-- .ladiesPhoto -->
        ...
        <div class="rightSIDE_contentWrapp">
                ...
                <div class="rightSIDE_content clearFix">
                        <table class="ladiesParams">
                                <tr>
                                        <?php if ($girl->birthday>0): ?> <td><p><?php echo __('date_of_birth'); ?></p><span><?php echo date('Y-m-d',$girl->birthday); ?></span></td> <?php endif; ?>
                                        <?php if ($girl->eyes>0): ?> <td><p><?php echo __('eyes'); ?></p><span><?php echo $sprav[$girl->eyes]->name; ?></span></td><?php endif; ?>
                                        <?php if ($girl->hair>0): ?><td><p><?php echo __('hair'); ?></p><span><?php echo $sprav[$girl->hair]->name; ?></span></td><?php endif; ?>
                                </tr>
                                <tr>
                                        <?php if ($girl->height>0): ?><td><p><?php echo __('height'); ?></p><span><?php echo $girl->get_height(); ?></span></td><?php endif; ?>
                                        <?php if ($girl->weight>0): ?><td><p><?php echo __('weight'); ?></p><span><?php echo $girl->get_weight(); ?></span></td><?php endif; ?>
                                        <?php if ($girl->children!=''): ?><td><p><?php echo __('number_of_children'); ?></p><span><?php echo $girl->children; ?></span></td><?php endif; ?>
                                </tr>
                                <tr>
                                        <?php if ($girl->smoking>0): ?><td><p><?php echo __('smoking'); ?></p><span><?php echo $sprav[$girl->smoking]->name; ?></span></td><?php endif; ?>
                                        <?php if ($girl->drinking>0): ?><td><p><?php echo __('drinking'); ?></p><span><?php echo $sprav[$girl->drinking]->name; ?></span></td><?php endif; ?>
                                        <?php if ($girl->religion>0): ?><td><p><?php echo __('religion'); ?></p><span><?php echo $sprav[$girl->religion]->name; ?></span></td><?php endif; ?>
                                </tr>
                                <tr>
                                        <?php if ($girl->marital_status>0): ?><td><p><?php echo __('marital_status'); ?></p><span><?php echo $sprav[$girl->marital_status]->name; ?></span></td><?php endif; ?>
                                        <?php if ($girl->education>0): ?><td><p><?php echo __('education'); ?></p><span><?php echo $sprav[$girl->education]->name; ?></span></td><?php endif; ?>
                                        <?php if ($girl->place_work!=''): ?><td><p><?php echo __('place_of_work'); ?></p><span><?php echo $girl->place_work; ?></span></td><?php endif; ?>
                                </tr>
