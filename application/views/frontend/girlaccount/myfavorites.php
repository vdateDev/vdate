...
<div class="inform_bar inform_succes">
    <a href="<?php echo strtolower(Route::url('default',array('language'=>$language, 'controller'=>'profile','action'=>'man', 'id'=>$new->user_id))); ?>"><?php echo $new->firstname; ?></a>
    <?php echo __('has_been_added_to_favorites'); ?>.
</div>
<?php endif; ?>
<p class="par1"><?php echo __('men_favorite_list'); ?> (<span><?php echo $count; ?></span> <?php echo __('men'); ?>)</p>
    ...
    <?php foreach ($men as $item): ?>
        <div class="favOne <?php if ($item->is_online()) echo 'favOnline'; ?>">
                ...
                <div class="favOneOpt">
                        ...
                        <a href="<?php echo strtolower(Route::url('default',array('language'=> $language,'controller'=>'girlaccount', 'action'=>'delfavorite' ,'id'=>$item->id_record))); ?>" class="oneDel delete_this"></a>
                </div>
                <div class="favOneInf">
