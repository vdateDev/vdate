<div class="conteiner">
    ...
    <div>
        <div class="ps_table_title">
            ...
            <div class="name_page">Value (kg)</div>
        </div>
        <?php if (sizeof($weight) > 0): ?>
           ...
           <?php foreach ($weight as $item): ?>
                ...
                <span class="p_wr">
                    <span class="control_link">
                        ...
                        <span class="coll_item">
                            [
                            <a class="ps_coll" href="<?php echo strtolower(Route::url('backend', array('controller' => 'weight', 'action' => 'edit', 'id' => $item->id))); ?>">Edit</a>
                            ]
                        </span>
                        <span class="coll_item">
                            [
                            <a class="ps_coll delete_this" href="<?php echo strtolower(Route::url('backend', array('controller' => 'weight', 'action' => 'delete', 'id' => $item->id))); ?>">Delete</a>
                            ]
                        </span>
                    </span>
                    <span class="name">
                        <?php echo $item->zna;?> kg
                    </span>
                </span>
            </li>
            <?php endforeach; ?>
...
<script type="text/javascript">weight_page();</script>
