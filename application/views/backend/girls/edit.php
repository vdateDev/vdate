                        ...
                        <div class="item_f_wrap">                    
                            <div class="item_1">                                                                  
                               <label class="block title_1">Photo of the first page :</label>                          
                                <?php if (empty($data['passport_photo'])): ?>
                                    <input name="passport" type="file" class="s_name input_1" value="">
                                <?php else: ?>
                                    <div class="contorl_edit">
                                        <?php if (HTML::isset_img('upload/girls/passport/'.$data['passport_photo'])): ?>
                                            <img src="<?php echo HTML::isset_img('upload/girls/passport/'.$data['passport_photo']); ?>">
                                        <?php endif; ?>
                                        <br>
                        ...
                        <div class="item_f_wrap">                    
                            <div class="item_1">                                                                  
                               <label class="block title_1">Photo of girl who take passport near with face :</label>                          
                                <?php if (empty($data['girl_with_passport'])): ?>
                                    <input name="girl_passport" type="file" class="s_name input_1" value="">
                                <?php else: ?>
                                    <div class="contorl_edit">
                                        <?php if (HTML::isset_img('upload/girls/girl_passport/'.$data['girl_with_passport'])): ?>
                                            <img src="<?php echo HTML::isset_img('upload/girls/girl_passport/'.$data['girl_with_passport']); ?>">
                                        <?php endif; ?>
                                        <br>
                                        <input class="b middle red" type="submit" name="delete_image_girl_passport" value="Delete image" style="vertical-align: middle;">
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
