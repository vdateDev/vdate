            ...
            <div class="items_wrap">
                <div class="item_f_wrap">
                    <div class="item_col">
                     ...
                     <div class="item_col">
                        <label class="title_1">For:</label>                        
                        <select name='type'>
                            <option value="0" <?php echo $data['type'] == 0 ? 'selected' : ''; ?>>Man or Woman</option>
                            <option value="1" <?php echo $data['type'] == 1 ? 'selected' : ''; ?>>Man</option>
                            <option value="2" <?php echo $data['type'] == 2 ? 'selected' : ''; ?>>Woman</option>
                        </select>
                    </div>   
                </div>
                        ...
                        <div class="langBox <?php echo $lang->default == 1 ? 'active' : ''; ?>" id="lang-<?php echo $lang->key; ?>">
                            <div class="item_f_wrap">
                                <div class="item_1">
                                    ...
                                    <input name="<?php echo $lang->key; ?>[text]" type="text" class="input_1" value="<?php echo $data[$lang->key]['text']; ?>" >
                                </div>
                             </div>
