            ...
            <div class="items_wrap">
                <div class="item_f_wrap">
                    ...
                    <div class="item_col" style="width:350px">
                        ...
                        <input type="text" value="<?php echo date('d.m.Y', $data['date_news']); ?>" class="input_1" style="width:200px;" name="date" id="datepicker"/>
                    </div>
                </div>
                ...
                <div class="item_f_wrap">                    
                    <div class="item_1">                                                                  
                        ...
                        <?php if (empty($data['image'])): ?>
                            <input name="image" type="file" class="s_name input_1" value="">
                        <?php else: ?>
                            <div class="contorl_edit">
                                <?php if (HTML::isset_img('upload/news/medium_'.$data['image'])): ?>
                                    <img src="<?php echo HTML::isset_img('upload/news/medium_'.$data['image']); ?>">
                                <?php endif; ?>
                                <?php if (HTML::isset_img('upload/news/big_'.$data['image'])): ?>
                                    <img src="<?php echo HTML::isset_img('upload/news/big_'.$data['image']); ?>">
                                <?php endif; ?>
                                <br>
                                <input class="b middle red" type="submit" name="delete_image" value="Delete image" style="vertical-align: middle;">
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
