...
<div class="conteiner">
    <h1>Virtual Gifts &rAarr; Edit virtual gift &rAarr; <?php echo $data['en']['name']; ?></h1>
                    ...
                    <div class="item_1">                                                                  
                        ...
                        <?php else: ?>
                            <div class="contorl_edit">
                                <?php if (HTML::isset_img('upload/virtualgifts/'.$data['image'])): ?>
                                    <img src="<?php echo HTML::isset_img('upload/virtualgifts/'.$data['image']); ?>">
                                <?php endif; ?>
                                <br>
