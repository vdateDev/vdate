<div class="conteiner">
    <h1>Gifts &rAarr; Gifts management</h1>
    
    <div class="filter_wrap">
        <div class="textcenter">
            <form method="get" id="submitGetForm">
                <div class="filter_item">
                    <label class="middle"><strong>Category:</strong></label>
                    <select class="middle" name="group_id">
    ...
    <div>
        <div class="ps_table_title">
            <div class="coll_title">
                <span class="coll_item">Category</span>
            ...
            <?php foreach ($gifts AS $item):?>
                ...
                <span class="p_wr">
                    <span class="control_link">
                        ...
                        <span class="coll_item">
                            [
                            <a class="ps_coll" href="<?php echo strtolower(Route::url('backend', array('controller' => 'gifts', 'action' => 'edit', 'id' => $item->id))); ?>">Edit</a>
                            ]
                        </span>
                        <span class="coll_item">
                            [
                            <a class="ps_coll delete_this" href="<?php echo strtolower(Route::url('backend', array('controller' => 'gifts', 'action' => 'delete', 'id' => $item->id))); ?>">Delete</a>
                            ]
                        </span>
                    </span>
                    <span class="name">
...
<script type="text/javascript">page_gifts();</script>
