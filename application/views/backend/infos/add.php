<div class="conteiner">
    <h1>Messages management &rAarr; Add new message</h1>
            ...
            <div class="items_wrap">
                <div class="item_f_wrap">
                    <div class="item_col">
                        ...
                        <select name="status">
                            <option value="0" <?php echo $data['status'] == 0 ? 'selected' : ''; ?>>Unpubllished</option>
                    ...
                    <div class="item_col" style="width:450px">
                        ...
                        <input type="text" value="<?php echo $data['key']; ?>" class="input_1" style="width:350px;" name="key" />
                    </div>
                </div>
                <div class="item_f_wrap">
                    <div class="item_1">
                        ...
                        <select name="type">
                            <option value="alert">Just message (white color)</option>
                            <option value="warning">Warning (yellow)</option>
                            <option value="information">Informational (blue)</option>
                            <option value="success">Successfully (green)</option>
                            <option value="error">Error (red)</option>
                        </select>
                    </div>       
                    <div class="item_1" style="width:350px">
                        <label class="block title_1">Display time (in seconds):</label>                        
                        <input type="text" maxlength="5" value="2.5" class="input_1" style="width:250px;" name="time" />
                    </div>
                </div>
                ...
                <div class="langsContentContainer">
                    <?php foreach($languages AS $lang): ?>
                        <div class="langBox <?php echo $lang->default == 1 ? 'active' : ''; ?>" id="lang-<?php echo $lang->key; ?>">                            
                            <div class="item_f_wrap">
                                <div class="item_1">
                                    <label class="block title_1">Messages: <span class="red">*</span></label>                           
