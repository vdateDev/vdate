...
<div class="conteiner">
    <h1>Gift categories &rAarr; Edit category &rAarr; <?php echo $data['en']['name']; ?></h1>
                        ...
                        <div class="langBox <?php echo $lang->default == 1 ? 'active' : ''; ?>" id="lang-<?php echo $lang->key; ?>">
                            <div class="item_f_wrap">
                                <div class="item_1">
                                    ...
                                    <input name="<?php echo $lang->key; ?>[name]" type="text" class="s_name input_1" value="<?php echo $data[$lang->key]['name']; ?>">
                                </div>
                             </div>
                        </div>
                    <?php endforeach; ?>
