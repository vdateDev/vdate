                ...
                <span class="p_wr">
                    <span class="control_link">
                        ...
                        <span class="coll_item">
                            [
                              <?php if ($item->type==0):?>
                                <span class="ps_coll is_visible active">Man or Woman</span>
                              <?php elseif ($item->type==1):?>
                               <span class="ps_coll is_visible active">Man</span>
                              <?php else: ?>
                               <span class="ps_coll is_visible active">Woman</span>
                              <?php endif;?>
                            ]
                        </span>
                        <span class="coll_item">
                            [
                            <a class="ps_coll" href="<?php echo strtolower(Route::url('agency_sprav', array('controller' => 'sprav', 'category'=>$category, 'action' => 'edit', 'id' => $item->id))); ?>">Edit</a>
                            ]
                        </span>
                        <span class="coll_item">
                            [
                            <a class="ps_coll delete_this" href="<?php echo strtolower(Route::url('agency_sprav', array('controller' => 'sprav', 'category'=>$category, 'action' => 'delete', 'id' => $item->id))); ?>">Delete</a>
                            ]
                        </span>
                    </span>
                    <span class="name">
