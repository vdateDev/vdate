            ...
            <?php foreach ($data as $item): ?>
                ...
                <span class="p_wr">
                    <span class="control_link">
                        ...
                        <span class="coll_item">
                            [
                            <a class="ps_coll" href="<?php echo strtolower(Route::url('agency_sprav', array('controller' => 'sprav', 'categoty'=>$category, 'action' => 'edit', 'id' => $item->id))); ?>">Edit</a>
                            ]
                        </span>
                        <span class="coll_item">
                            [
                            <a class="ps_coll delete_this" href="<?php echo strtolower(Route::url('agency_sprav', array('controller' => 'sprav', 'categoty'=>$category, 'action' => 'delete', 'id' => $item->id))); ?>">Delete</a>
                            ]
                        </span>
                    </span>
                    <span class="name">
