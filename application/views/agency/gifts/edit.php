...
<div class="conteiner">
    <h1>Gifts &rAarr; Edit gift &rAarr; <?php echo $data['en']['name']; ?></h1>
                    ...
                    <div class="item_1">                                                                  
                        ...
                        <?php else: ?>
                            <div class="contorl_edit">
                                <?php if (HTML::isset_img('upload/gifts/'.$data['image'])): ?>
                                    <img src="<?php echo HTML::isset_img('upload/gifts/'.$data['image']); ?>">
                                <?php endif; ?>
                                <br>
