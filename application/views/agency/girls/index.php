            ...
            <?php foreach ($girls AS $item):?>
                ...
                <span class="p_wr">
                    <span class="control_link">
                        ...
                        <span class="coll_item">
                            [
                            <a class="ps_coll" href="<?php echo strtolower(Route::url('agency', array('controller' => 'girls', 'action' => 'edit', 'id' => $item->user_id))); ?>">Edit</a>
                            ]
                        </span>
                        <span class="coll_item">
                            [
                            <a class="ps_coll delete_this" href="<?php echo strtolower(Route::url('agency', array('controller' => 'girls', 'action' => 'delete', 'id' => $item->user_id))); ?>">Delete</a>
                            ]
                        </span>
                    </span>
                    <span class="name">
