<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../../upload/content/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../../upload/content/'; // absolute or relative from this script path.
