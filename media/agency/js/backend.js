function fields() {
	...
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency_ajax/fields/status',
			{
				id: $(this).attr('id'),
...
function banners() {
	...
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency_ajax/banners/status',
			{
				id: $(this).attr('id'),
				status: ($(this).is('.active') ? 0 : 1)
...
function page_letters() {
	...
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency_ajax/letters/status',
			{
				id: $(this).attr('id'),
				status: ($(this).is('.active') ? 0 : 1)
...
function page_slideshow() {
	$(document).ready(function(e) {
		  ...
		  update : function () {
			...
			var sort_wrap = $(this);
				...
				$.ajax({
					...
					url: "/agency_ajax/slideshow/sort",
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency_ajax/slideshow/status',
			{
				id: $(this).attr('id'),
				status: ($(this).is('.active') ? 0 : 1)
...
function page_actual() {
	$(document).ready(function(e) {
		...
		$('.delete_this').click(function(e) {
        	...
        	$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency_ajax/actual/status',
			{
				id: $(this).attr('pid'),
				status: ($(this).is('.active') ? 0 : 1)
...
function page_languages() {
	$(document).ready(function(e) {
		  ...
		  update : function () {
			...
			var sort_wrap = $(this);
				...
				$.ajax({
					...
					url: "/agency_ajax/languages/sort",
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency_ajax/languages/status',
			{
				id: $(this).attr('id'),
				status: ($(this).is('.active') ? 0 : 1)
...
function page_products(page_num)
{
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/product_status',
			{
				pid:$(this).attr('pid'),
...
function page_main(page_num)
{
	$(document).ready(function(e) {
		...
		$('.ps_coll.menu_item').click(function(){
			_this = $(this);
			$.post('/agency/ajax/change_menu_item_status',
			{
				pid:$(this).attr('pid'),
		...
		$('.ps_coll.index').click(function(){
			if ($(this).is('.active'))
				return false;
			_this = $(this);
			$.post('/agency/ajax/change_index_status',
			{
				pid:$(this).attr('pid'),
			},
			function(data){
...
function page_regions(page_num)
{
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/regions_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_discussions(page_num)
{
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/discussions_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_overviews(page_num)
{
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/overviews_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_banners(page_num)
{
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/banner_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_brands(page_num)
{
	$(document).ready(function(e) {
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/brands_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_categories(page_num)
{
	$(document).ready(function(e) {
		  ...
		  update : function () {
			...
			var sort_wrap = $(this);
				...
				$.ajax({
					...
					url: "/agency/ajax/sort_categories",
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/categories_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_filters(page_num)
{
	$(document).ready(function(e) {
		  ...
		  update : function () {
			...
			var sort_wrap = $(this);
				...
				$.ajax({
					...
					url: "/agency/ajax/sort_filters_items",
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/filters_items_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_filters_groups(page_num)
{
	$(document).ready(function(e) {
		  ...
		  update : function () {
			...
			var sort_wrap = $(this);
				...
				$.ajax({
					...
					url: "/agency/ajax/sort_filters_groups",
		...
		$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/filters_groups_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
...
function page_inner()
{
	$(document).ready(function(e) {
			...
			$('.ps_coll.is_visible').click(function(){
			_this = $(this);
			$.post('/agency/ajax/change_visible_status',
			{
				pid:$(this).attr('pid'),
				visible:($(this).is('.active') ? 0 : 1)
	...
	$(document).ready(function(e) {
        $('.message_display').click(function(e) {
			...
			$("#dialog").dialog({
				...
				buttons: {
					'Удалить' : function () {
						document.location='/agency/feedback/delete/'+_div.attr('pid')+'/'+_div.attr('hs');
						$(this).dialog( "close" ).dialog("destroy");
					},
					'Переместить в прочитанные' : function () {
						document.location='/agency/feedback/change_read/'+_div.attr('pid');
						$(this).dialog( "close" ).dialog("destroy");
					},
					'Закрыть': function() {
						$(this).dialog( "close" ).dialog("destroy");
    ...
    $(document).ready(function(e) {
        ...
        $('ul#sortable').sortable({
            ...
            update : function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/agency_ajax/giftgroups/sort",
                    data: order
                });
                $(this).addClass('tp');   
            }
        ...
        $('.ps_coll.is_visible').click(function(){
            _this = $(this);
            $.post('/agency_ajax/giftgroups/status',
            {
                    id: $(this).attr('pid'),
                    status: ($(this).is('.active') ? 0 : 1)
    ...
    $(document).ready(function(e) {
        ...
        $('ul#sortable').sortable({
            ...
            update : function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/agency_ajax/virtfualgiftgroups/sort",
                    data: order
                });
                $(this).addClass('tp');   
            }
        ...
        $('.ps_coll.is_visible').click(function(){
            _this = $(this);
            $.post('/agency_ajax/virtualgiftgroups/status',
            {
                    id: $(this).attr('pid'),
                    status: ($(this).is('.active') ? 0 : 1)
...
function weight_page() {
    $(document).ready(function(e) {
        ...
        $('.ps_coll.is_visible').click(function(){
            _this = $(this);
            $.post('/agency_ajax/weight/status',
            {
                    id: $(this).attr('id'),
                    status: ($(this).is('.active') ? 0 : 1)
    ...
    $(document).ready(function(e) {
        ...
        $('ul#sortable').sortable({
            ...
            update : function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/agency_ajax/virtualgifts/sort",
                    data: order
                });
                $(this).addClass('tp');   
            }
        ...
        $('.ps_coll.is_visible').click(function(){
            _this = $(this);
            $.post('/agency_ajax/virtualgifts/status',
            {
                    id: $(this).attr('pid'),
                    status: ($(this).is('.active') ? 0 : 1)
...
function list_photos() {
    $(document).ready(function(e){
        ...
        $('#uploaded-images').on('click', '.default-image', function(event) {        
            ...
            $.ajax({
                type: 'POST',
                url: '/agency_ajax/photos/defaultimage',
                dataType: 'JSON',
                data: {
                    id : imageId      
                },
